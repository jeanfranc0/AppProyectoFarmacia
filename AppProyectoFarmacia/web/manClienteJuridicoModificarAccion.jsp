...
<body>
    <jsp:useBean id="Cliente" class="data.cClienteJuridico" scope="page"></jsp:useBean>
        <%
            ...
            if(id!=null)
            {
                Cliente.modificar(id, direccion, telefono, ruc, razon);
            ...
            else
            {
                if(razon!=null)
                {
                    datos=Cliente.buscar("Razon_Social", razon);
...
<div id="bodyPan">
  ...
  <div id="rightPan">
    <div id="rightbodyPan">
      ...
      <form action="manClienteJuridicoModificarAccion.jsp">
            ...
            <input type="text" name="txtRUC" value="<%=documento.getString("RUC")%>" minlenght="6" maxlength="9" onkepress="javascript:return validar_numeros(event)" onpaste="return false"><br><br>
            <label for="Razon">Razon Social: </label>
            <input type="text" name="txtRazon"  value="<%=documento.getString("Razon_Social")%>" onkepress="javascript:return validar_numeros(event)" onpaste="return false" ><br><br>
